...
public class WellnessActivity extends Activity {
	...
	private static final String TAG = WellnessActivity.class.getName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listView = (ListView) findViewById(R.id.wellness_activity_list_view);

		// initialize the list view header
		view = (View) getLayoutInflater().inflate(R.layout.wellness_activity_header, null);
		...
		relativeLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivityForResult(new Intent(WellnessActivity.this, WellnessFormActivity.class), FRESH_FORM_REQUEST_CODE);
			}
		});
		...
		relativeLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(WellnessActivity.this, WellnessReportActivity.class));
			}
		});
	...
	private void generateODLList() {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.list_item_one_arrow, R.id.list_item_one_arrow_text, odlDateList);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
				intent = new Intent(WellnessActivity.this, WellnessFormActivity.class);
